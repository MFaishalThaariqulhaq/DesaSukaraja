...
<section id="berita-list" class="py-12 bg-slate-50">
  <div class="container mx-auto px-6">
    <div style="display: flex; gap: 48px;">
      ...
      <aside style="flex: 0 0 calc(33.333% - 24px);" data-aos="fade-right" data-aos-delay="100">
    ...
    <main style="flex: 1; min-width: 0;">
      ...
      <div class="flex flex-wrap gap-8">
        ...
        <article class="flex-1 min-w-[300px] bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 border border-slate-100 group flex flex-col h-full berita-item"
